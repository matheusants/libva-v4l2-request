...
Verified via libva (ffmpeg -hwaccel vaapi) and GStreamer (v4l2slh264dec). ~22fps at 1440×1080.

**H265 HW decode: WORKING** — 4-control stateless API (SPS + PPS + DECODE_PARAMS + SLICE_PARAMS).
Verified via libva (ffmpeg). ~22fps at 1440×1080.
...
```sh
# ffmpeg -- HW decode null output (30s)
